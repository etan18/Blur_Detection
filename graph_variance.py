...
def main(frame=-1, filename=DEFAULT_FILE_NAME):
    ...
    slope, intercept, r_value, p_value, std_err = scipy.stats.linregress(blurriness_array,R_array)
    print("r_value: " + str(r_value))
    plt.plot(blurriness_array, slope*numpy.asarray(blurriness_array)+intercept)
